...
const double k_gender_text_size_portrait = 48.0;

/// Font size for the main gender reveal text (landscape).
const double k_gender_text_size_landscape = 64.0;

/// Font size for the baby name text (portrait).
const double k_baby_name_text_size_portrait = 32.0;

/// Font size for the baby name text (landscape).
const double k_baby_name_text_size_landscape = 42.0;
